 ...
 * \param [in] inscalar_VectorsKernel_N Input scalar parameter "VectorsKernel.N".
...
void Vectors(
	int32_t param_N,
	uint64_t inscalar_VectorsKernel_N,
...
typedef struct { 
	...
	uint64_t inscalar_VectorsKernel_N; /**<  [in] Input scalar parameter "VectorsKernel.N". */
	const float *instream_x; /**<  [in] The stream should be of size (param_N * 4) bytes. */
	float *outstream_z; /**<  [out] The stream should be of size (param_N * 4) bytes. */
} Vectors_actions_t;
